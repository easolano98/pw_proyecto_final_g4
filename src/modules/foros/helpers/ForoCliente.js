...
export const consultarComentariosForoFachada = async (asunto) => {
    return await consultarComentariosForo(asunto)
}
...
const consultarComentariosForo = async (asunto) => {
    const data = await axios.get(`http://localhost:8080/API/v1.0/Facultad/foros/${asunto}/comentarios`).then(r => r.data)
    return data
}
