...
const consultarNoticia=async(titulo)=>{
    ...
    const data= axios.get(`http://localhost:8080/API/v1.0/Facultad/noticias/${titulo}`).then(r=>r.data)
    return data
 ...
 const consultarNoticiaEstudiante=async(cedula)=>{
    ...
    const data= axios.get(`http://localhost:8080/API/v1.0/Facultad/noticias?cedula=${cedula}`).then(r=>r.data)
    return data
 ...
 const consultarNoticias=async()=>{
    ...
    const data= axios.get(`http://localhost:8080/API/v1.0/Facultad/noticias/`).then(r=>r.data)
    return data
